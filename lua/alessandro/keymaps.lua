...
-- This one makes it so that when you yank and paste the overwritten text does not substitute the yanked text
keymap("v", "p", '"_dP', opts)
...
-- Which-Key
keymap("n", "<leader>h", "<cmd>WhichKey<cr>", createOpts("Show WhichKey"))
keymap("v", "<leader>h", "<cmd>WhichKey<cr>", createOpts("Show WhichKey"))
